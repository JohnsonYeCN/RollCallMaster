    ...
    return {
        ...
        initChat: function () {
            ...
            var handleClick = function (e) {
                ...
                var tpl = '';
                tpl += '<li class="out">';
                tpl += '<img class="avatar" alt="" src="/default/assets/img/avatar1.jpg"/>';
        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    text: '欢迎使用我们的点名系统，这里是教师平台。您能够发起点名、查看点名结果等。',
                    // (string | optional) the image to display on the left
                    //image: '/media/assets/img/avatar1.jpg',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    // (string | mandatory) the heading of the notification
                    title: '欢迎使用我们的Android端!',
                    // (string | mandatory) the text inside the notification
                    text: 'Android平台也有我们的此项应用，您可以使用应用登录，更方便更快捷！',
                    // (string | optional) the image to display on the left
                    //image: '/default/media/assets/img/avatar1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
