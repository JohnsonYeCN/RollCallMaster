					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-cogs"></i>公寓查寝</div>
							...
							<div class="portlet-body">
								...
								<div class="alert alert-block alert-info fade in">
									...
									<h4 class="alert-heading">选择公寓</h4>

									<p>

										在下拉菜单的选项中选择您要发起查寝的公寓，然后点击点名开始。
									...
									<p>
												<div class="control-group">
													...
													<div class="controls">
													<form action="index.php?/callhold" method="post">

														<select class="large m-wrap" tabindex="1" name="courseid">
																<?php
																	$dorm_query = new Dormcallprepare();
																	$res = $dorm_query->getcourses();
																?>
													...
													<input type="submit" class="btn blue m-wrap" value="发起点名" />
													</form>
