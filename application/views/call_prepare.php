...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-cogs"></i>课堂点名</div>
							...
							<div class="portlet-body">
								...
								<?php
									$course_query = new Callprepare();
									$res = $course_query->getcourses();
								?>

								

								<div class="alert alert-block alert-info fade in" id="selectcourse">

									<button type="button" class="close" data-dismiss="alert"></button>

									<h4 class="alert-heading">选择课程</h4>

									<p>


										在下拉菜单的选项中选择您要发起点名的课程，然后点击点名开始。
										<input id="checkcode" value="<?php echo $course_query->getRandstr(4);?>" hidden="true"/>
										<input id="latitude" value="0" hidden="true"/>
										<input id="longitude" value="0" hidden="true"/>
									...
									<p>
										...
										<h5>验证码：<?php echo $course_query->getCode();?></h5>
									...
									<p>
												<div class="control-group" >
													...
													<div class="controls">
													<form action="index.php?/callhold" name="select_course_form" method="post">


														<select class="large m-wrap" tabindex="1" id="courseid" >
													...
													<input type="button" class="btn blue m-wrap" value="发起点名" onclick="callhold()" />
													</form>
							...
							<div class="portlet-body" >
								...
								<div class="alert alert-block alert-info fade in" id="showcall" hidden="false">

										
										<h4 class="alert-heading">正在点名</h4>

										<p>

											您的学生现在有一分钟的时间输入验证码签到。
										...
										<p>
											...
											<div class="warp">
											<h2 class="text-danger"><span class="glyphicon glyphicon-time"></span> <span id="clock2"></span></h2>
											</div>
										</p>
	...
	<script src="media/js/cd_jquery.countdown.js"></script>
	<script>
	/**
	function startcountdown(){
		...
		$('#clock2').countdown(second, function(event) {
			...
			$(this).parent().hide().html('<button class="btn btn-success btn-lg"><span class="glyphicon glyphicon-headphones"></span> 查看点名结果(来自内部)</button>').show().addClass('animated bounceIn').closest('.panel').removeClass('panel-primary').addClass('panel-success');
		});
	};
	*/
	</script>
	...
	<script type="text/javascript" src="http://webapi.amap.com/maps?v=1.3&key=604df009bb29c1ffd252d289d48ce706ff"></script>
