...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<?php
										$record_query = new Showrecordbycourse();
							...
							<li>
							<a href="#"><?php echo "TODO:coursename";?></a>
							<i class="icon-angle-right"></i>
							</li>
	...
	<script src="media/js/table-managed-showbycourse.js"></script>     
