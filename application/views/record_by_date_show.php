...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							历史记录查看 <small>按日期查看您的历史点名记录</small>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<thead>
										...
										<tr>
											...
											<th >时间</th>
											<th >课程名</th>
											<th class="hidden-480">教学对象</th>
											<th class="hidden-480">到课人数</th>
											<th>请假人数</th>
											<th class="hidden-480">缺席人数</th>
											<th >查看</th>
										</tr>
									...
									<?php
										$record_query = new Showrecordbydate();
										$res = $record_query->getrecords();
									?>
									<tbody>
											...
											<tr class="odd gradeX">
											  ...
											  <td>
													<a href="index.php?/getrecordbyid/index/<?php echo $value->objectId;?>"><span class="label label-success">详情</span></a>
											  </td>
	...
	<script src="media/js/table-managed-showbydate.js"></script>     
